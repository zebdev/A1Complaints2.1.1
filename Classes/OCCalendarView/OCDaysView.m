...
- (void)drawRect:(CGRect)rect
{
    ...
    int numDaysInPrevMonth = (int)[calendar rangeOfUnit:NSDayCalendarUnit
										inUnit:NSMonthCalendarUnit 
    ...
    for(int i = 0; i <= weekdayOfFirst-2; i++) {
        ...
        [str drawInRect: dayHeader2Frame  withAttributes:@{NSFontAttributeName:textFont, NSParagraphStyleAttributeName:textStyle}];
