...
- (NSDate *)getStartDate {
	...
	int numDaysInMonth = (int)[calendar rangeOfUnit:NSDayCalendarUnit
...
-(void) renderCalendarViewForPhone
{
    ...
    for(int i = 0; i < dayTitles.count; i++) {
        ...
        [((NSString *)[dayTitles objectAtIndex:i]) drawInRect:dayHeaderFrame withAttributes:@{NSFontAttributeName:textFont, NSParagraphStyleAttributeName:textStyle}];
    ...
    [[UIColor whiteColor] setFill];
    [monthTitle drawInRect: textFrame  withAttributes:@{NSFontAttributeName:textFont, NSParagraphStyleAttributeName:textStyle}];
    CGContextRestoreGState(context);
...
-(void) renderCalendarViewForPad
{
    ...
    for(int i = 0; i < dayTitles.count; i++) {
        ...
        [[UIColor whiteColor] setFill];
        [((NSString *)[dayTitles objectAtIndex:i]) drawInRect: dayHeaderFrame withAttributes:@{NSFontAttributeName:textFont, NSParagraphStyleAttributeName:textStyle}];        CGContextRestoreGState(context);
    }
