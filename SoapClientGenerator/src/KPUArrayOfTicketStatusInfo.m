...
@implementation KPUArrayOfTicketStatusInfo

@synthesize items;

+ (KPUArrayOfTicketStatusInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"TicketStatusInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUTicketStatusInfo*)[__request createObject:child type:[KPUTicketStatusInfo class]]];
        }
...
{
    for (KPUTicketStatusInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUTicketStatusInfo class] name:@"TicketStatusInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUTicketStatusInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUTicketStatusInfo*)anObject {
...
- (BOOL)containsObject:(KPUTicketStatusInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUTicketStatusInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUTicketStatusInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketStatusInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketStatusInfo*)anObject inRange:(NSRange)range {
...
- (KPUTicketStatusInfo*)lastObject {
...
- (void)addObject:(KPUTicketStatusInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUTicketStatusInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUTicketStatusInfo*)anObject {
...
- (void)removeObject:(KPUTicketStatusInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUTicketStatusInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUTicketStatusInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUTicketStatusInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfTicketStatusInfo alloc] init];
}

+ (id)arrayWithObject:(KPUTicketStatusInfo*)anObject {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUTicketStatusInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUTicketStatusInfo*)firstObj, ... {
	KPUArrayOfTicketStatusInfo* a = [ KPUArrayOfTicketStatusInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUTicketStatusInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfTicketStatusInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUTicketStatusInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketStatusInfo*, KPUTicketStatusInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketStatusInfo*, KPUTicketStatusInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUTicketStatusInfo*, KPUTicketStatusInfo*, void *))compare context:(void *)context {
