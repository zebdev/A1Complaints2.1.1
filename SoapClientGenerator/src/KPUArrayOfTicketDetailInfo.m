...
@implementation KPUArrayOfTicketDetailInfo

@synthesize items;

+ (KPUArrayOfTicketDetailInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"TicketDetailInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUTicketDetailInfo*)[__request createObject:child type:[KPUTicketDetailInfo class]]];
        }
...
{
    for (KPUTicketDetailInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUTicketDetailInfo class] name:@"TicketDetailInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUTicketDetailInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUTicketDetailInfo*)anObject {
...
- (BOOL)containsObject:(KPUTicketDetailInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUTicketDetailInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUTicketDetailInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketDetailInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketDetailInfo*)anObject inRange:(NSRange)range {
...
- (KPUTicketDetailInfo*)lastObject {
...
- (void)addObject:(KPUTicketDetailInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUTicketDetailInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUTicketDetailInfo*)anObject {
...
- (void)removeObject:(KPUTicketDetailInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUTicketDetailInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUTicketDetailInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUTicketDetailInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfTicketDetailInfo alloc] init];
}

+ (id)arrayWithObject:(KPUTicketDetailInfo*)anObject {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUTicketDetailInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUTicketDetailInfo*)firstObj, ... {
	KPUArrayOfTicketDetailInfo* a = [ KPUArrayOfTicketDetailInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUTicketDetailInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfTicketDetailInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUTicketDetailInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketDetailInfo*, KPUTicketDetailInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketDetailInfo*, KPUTicketDetailInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUTicketDetailInfo*, KPUTicketDetailInfo*, void *))compare context:(void *)context {
