...
@implementation KPUArrayOfAssetInfo
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"AssetInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUAssetInfo*)[__request createObject:child type:[KPUAssetInfo class]]];
        }
...
{
    for (KPUAssetInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUAssetInfo class] name:@"AssetInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(KPUAssetInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUAssetInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfAssetInfo alloc] init];
}

+ (id)arrayWithObject:(KPUAssetInfo*)anObject {
	return [[ KPUArrayOfAssetInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUAssetInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfAssetInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUAssetInfo*)firstObj, ... {
	KPUArrayOfAssetInfo* a = [ KPUArrayOfAssetInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUAssetInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfAssetInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfAssetInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfAssetInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfAssetInfo alloc] initWithCapacity:numItems];
}
