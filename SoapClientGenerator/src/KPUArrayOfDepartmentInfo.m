...
@implementation KPUArrayOfDepartmentInfo

@synthesize items;

+ (KPUArrayOfDepartmentInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"DepartmentInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUDepartmentInfo*)[__request createObject:child type:[KPUDepartmentInfo class]]];
        }
...
{
    for (KPUDepartmentInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUDepartmentInfo class] name:@"DepartmentInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUDepartmentInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUDepartmentInfo*)anObject {
...
- (BOOL)containsObject:(KPUDepartmentInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUDepartmentInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUDepartmentInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUDepartmentInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUDepartmentInfo*)anObject inRange:(NSRange)range {
...
- (void)addObject:(KPUDepartmentInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUDepartmentInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUDepartmentInfo*)anObject {
...
- (void)removeObject:(KPUDepartmentInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUDepartmentInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUDepartmentInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUDepartmentInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfDepartmentInfo alloc] init];
}

+ (id)arrayWithObject:(KPUDepartmentInfo*)anObject {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUDepartmentInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUDepartmentInfo*)firstObj, ... {
	KPUArrayOfDepartmentInfo* a = [ KPUArrayOfDepartmentInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUDepartmentInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfDepartmentInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUDepartmentInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUDepartmentInfo*, KPUDepartmentInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUDepartmentInfo*, KPUDepartmentInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUDepartmentInfo*, KPUDepartmentInfo*, void *))compare context:(void *)context {
