...
{
    DDXMLNode* child=[KPUHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[KPUHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[KPUHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
