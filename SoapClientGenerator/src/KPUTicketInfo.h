...
@class KPUTicketInfo_TicketAttributes;
@class KPUHelper;
...
@interface KPUTicketInfo : NSObject <KPUISerializableObject>


@property (retain,nonatomic,getter=getObjAttachment) KPUAttachmentInfo* objAttachment;

@property (retain,nonatomic,getter=getTicketAttributes) KPUTicketInfo_TicketAttributes* TicketAttributes;

@property (retain,nonatomic,getter=getLocationName) NSString* LocationName;
...
@property (nonatomic,getter=getOverdueResolutionSLA) int OverdueResolutionSLA;
...
@property (nonatomic,getter=getActualResolutionSLA) int ActualResolutionSLA;
