...
@implementation KPUArrayOfCustomerInfo

@synthesize items;

+ (KPUArrayOfCustomerInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"CustomerInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUCustomerInfo*)[__request createObject:child type:[KPUCustomerInfo class]]];
        }
...
{
    for (KPUCustomerInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUCustomerInfo class] name:@"CustomerInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUCustomerInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUCustomerInfo*)anObject {
...
- (BOOL)containsObject:(KPUCustomerInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUCustomerInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUCustomerInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUCustomerInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUCustomerInfo*)anObject inRange:(NSRange)range {
...
- (void)addObject:(KPUCustomerInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUCustomerInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUCustomerInfo*)anObject {
...
- (void)removeObject:(KPUCustomerInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUCustomerInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUCustomerInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUCustomerInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfCustomerInfo alloc] init];
}

+ (id)arrayWithObject:(KPUCustomerInfo*)anObject {
	return [[ KPUArrayOfCustomerInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUCustomerInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfCustomerInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUCustomerInfo*)firstObj, ... {
	KPUArrayOfCustomerInfo* a = [ KPUArrayOfCustomerInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUCustomerInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfCustomerInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfCustomerInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfCustomerInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfCustomerInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUCustomerInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUCustomerInfo*, KPUCustomerInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUCustomerInfo*, KPUCustomerInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUCustomerInfo*, KPUCustomerInfo*, void *))compare context:(void *)context {
