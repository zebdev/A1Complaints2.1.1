...
@implementation KPUArrayOfTicketDeptSLA
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"TicketDeptSLA"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUTicketDeptSLA*)[__request createObject:child type:[KPUTicketDeptSLA class]]];
        }
...
{
    for (KPUTicketDeptSLA* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUTicketDeptSLA class] name:@"TicketDeptSLA" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(KPUTicketDeptSLA*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUTicketDeptSLA*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfTicketDeptSLA alloc] init];
}

+ (id)arrayWithObject:(KPUTicketDeptSLA*)anObject {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUTicketDeptSLA* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUTicketDeptSLA*)firstObj, ... {
	KPUArrayOfTicketDeptSLA* a = [ KPUArrayOfTicketDeptSLA array];
	id eachObject;
...
- (id)initWithObjects:(KPUTicketDeptSLA*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfTicketDeptSLA alloc] initWithCapacity:numItems];
}
