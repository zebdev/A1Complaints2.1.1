...
@implementation KPUArrayOfEngineerInfo

@synthesize items;

+ (KPUArrayOfEngineerInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"EngineerInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUEngineerInfo*)[__request createObject:child type:[KPUEngineerInfo class]]];
        }
...
{
    for (KPUEngineerInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUEngineerInfo class] name:@"EngineerInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUEngineerInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUEngineerInfo*)anObject {
...
- (BOOL)containsObject:(KPUEngineerInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUEngineerInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUEngineerInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUEngineerInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUEngineerInfo*)anObject inRange:(NSRange)range {
...
- (void)addObject:(KPUEngineerInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUEngineerInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUEngineerInfo*)anObject {
...
- (void)removeObject:(KPUEngineerInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUEngineerInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUEngineerInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUEngineerInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfEngineerInfo alloc] init];
}

+ (id)arrayWithObject:(KPUEngineerInfo*)anObject {
	return [[ KPUArrayOfEngineerInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUEngineerInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfEngineerInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUEngineerInfo*)firstObj, ... {
	KPUArrayOfEngineerInfo* a = [ KPUArrayOfEngineerInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUEngineerInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfEngineerInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfEngineerInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfEngineerInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfEngineerInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUEngineerInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUEngineerInfo*, KPUEngineerInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUEngineerInfo*, KPUEngineerInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUEngineerInfo*, KPUEngineerInfo*, void *))compare context:(void *)context {
