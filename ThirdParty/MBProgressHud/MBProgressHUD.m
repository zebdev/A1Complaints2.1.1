...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    gettingSizeLabel.font = detailsLabel.font ; // Your Font-style whatever you want to use.
    gettingSizeLabel.text = detailsLabel.text;
    gettingSizeLabel.lineBreakMode =detailsLabel.lineBreakMode;
    gettingSizeLabel.numberOfLines = 0;
    CGSize maximumLabelSize = maxSize; // this width will be as per your requirement
    
    CGSize detailsLabelSize = [gettingSizeLabel sizeThatFits:maximumLabelSize];
