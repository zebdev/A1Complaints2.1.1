...
KPUAppDataSoap* service = [[KPUAppDataSoap alloc]init];
...
Generator output:
1. any element is not supported.
2. any element is not supported.
3. any element is not supported.
4. any element is not supported.
5. any element is not supported.
6. any element is not supported.
7. any element is not supported.
8. Element  is not supported.
9. Element  is not supported.
10. Element  is not supported.
