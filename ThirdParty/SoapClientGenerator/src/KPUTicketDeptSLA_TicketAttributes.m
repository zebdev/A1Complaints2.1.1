...
@implementation KPUTicketDeptSLA_TicketAttributes

+ (KPUTicketDeptSLA_TicketAttributes *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
