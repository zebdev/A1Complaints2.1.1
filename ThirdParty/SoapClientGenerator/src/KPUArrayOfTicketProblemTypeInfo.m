...
@implementation KPUArrayOfTicketProblemTypeInfo

@synthesize items;

+ (KPUArrayOfTicketProblemTypeInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"TicketProblemTypeInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUTicketProblemTypeInfo*)[__request createObject:child type:[KPUTicketProblemTypeInfo class]]];
        }
...
{
    for (KPUTicketProblemTypeInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUTicketProblemTypeInfo class] name:@"TicketProblemTypeInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUTicketProblemTypeInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUTicketProblemTypeInfo*)anObject {
...
- (BOOL)containsObject:(KPUTicketProblemTypeInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUTicketProblemTypeInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUTicketProblemTypeInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketProblemTypeInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUTicketProblemTypeInfo*)anObject inRange:(NSRange)range {
...
- (KPUTicketProblemTypeInfo*)lastObject {
...
- (void)addObject:(KPUTicketProblemTypeInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUTicketProblemTypeInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUTicketProblemTypeInfo*)anObject {
...
- (void)removeObject:(KPUTicketProblemTypeInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUTicketProblemTypeInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUTicketProblemTypeInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUTicketProblemTypeInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] init];
}

+ (id)arrayWithObject:(KPUTicketProblemTypeInfo*)anObject {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUTicketProblemTypeInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUTicketProblemTypeInfo*)firstObj, ... {
	KPUArrayOfTicketProblemTypeInfo* a = [ KPUArrayOfTicketProblemTypeInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUTicketProblemTypeInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfTicketProblemTypeInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUTicketProblemTypeInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketProblemTypeInfo*, KPUTicketProblemTypeInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUTicketProblemTypeInfo*, KPUTicketProblemTypeInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUTicketProblemTypeInfo*, KPUTicketProblemTypeInfo*, void *))compare context:(void *)context {
