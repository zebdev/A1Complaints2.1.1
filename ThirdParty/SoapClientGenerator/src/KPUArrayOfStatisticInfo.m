...
@implementation KPUArrayOfStatisticInfo

@synthesize items;

+ (KPUArrayOfStatisticInfo *)createWithXml:(DDXMLElement *)__node __request:(KPURequestResultHandler*) __request
{
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"StatisticInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUStatisticInfo*)[__request createObject:child type:[KPUStatisticInfo class]]];
        }
...
{
    for (KPUStatisticInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUStatisticInfo class] name:@"StatisticInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (KPUStatisticInfo*)objectAtIndex:(NSUInteger)index {
	return [self.items objectAtIndex:index];
}

- (NSArray *)arrayByAddingObject:(KPUStatisticInfo*)anObject {
...
- (BOOL)containsObject:(KPUStatisticInfo*)anObject {
...
- (NSUInteger)indexOfObject:(KPUStatisticInfo*)anObject {
	return [self.items indexOfObject:anObject];
}

- (NSUInteger)indexOfObject:(KPUStatisticInfo*)anObject inRange:(NSRange)range {
	return [self.items indexOfObject:anObject inRange:range];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUStatisticInfo*)anObject {
	return [self.items indexOfObjectIdenticalTo:anObject];
}

- (NSUInteger)indexOfObjectIdenticalTo:(KPUStatisticInfo*)anObject inRange:(NSRange)range {
...
- (void)addObject:(KPUStatisticInfo*)anObject {
	return [self.items addObject:anObject];
}

- (void)insertObject:(KPUStatisticInfo*)anObject atIndex:(NSUInteger)index {
...
- (void)replaceObjectAtIndex:(NSUInteger)index withObject:(KPUStatisticInfo*)anObject {
...
- (void)removeObject:(KPUStatisticInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObject:anObject inRange:range];
}

- (void)removeObject:(KPUStatisticInfo*)anObject {
	return [self.items removeObject:anObject];
}

- (void)removeObjectIdenticalTo:(KPUStatisticInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUStatisticInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfStatisticInfo alloc] init];
}

+ (id)arrayWithObject:(KPUStatisticInfo*)anObject {
	return [[ KPUArrayOfStatisticInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUStatisticInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfStatisticInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUStatisticInfo*)firstObj, ... {
	KPUArrayOfStatisticInfo* a = [ KPUArrayOfStatisticInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUStatisticInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfStatisticInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfStatisticInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfStatisticInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfStatisticInfo alloc] initWithCapacity:numItems];
}

- (id)initWithObjects:(const KPUStatisticInfo* *)objects count:(NSUInteger)cnt {
	self = [self init];
	if(self) {
...
- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUStatisticInfo*, KPUStatisticInfo*, void *))comparator context:(void *)context {
	return [self.items sortedArrayUsingFunction:comparator context:context];
}

- (NSArray *)sortedArrayUsingFunction:(NSInteger (*)(KPUStatisticInfo*, KPUStatisticInfo*, void *))comparator context:(void *)context hint:(NSData *)hint {
	return [self.items sortedArrayUsingFunction:comparator context:context hint:hint];
}

- (void)sortUsingFunction:(NSInteger (*)(KPUStatisticInfo*, KPUStatisticInfo*, void *))compare context:(void *)context {
