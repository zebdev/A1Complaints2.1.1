...
@implementation KPUArrayOfTicketInfo
...
- (id) initWithXml: (DDXMLElement*) __node __request:(KPURequestResultHandler*) __request {
    if(self = [self init])
    {
        NSArray* tempItems = [__node elementsForName:@"TicketInfo"];
        for(DDXMLElement* child in tempItems)
        {
            [self.items addObject:(KPUTicketInfo*)[__request createObject:child type:[KPUTicketInfo class]]];
        }
...
{
    for (KPUTicketInfo* item in self.items) {
        DDXMLElement* propertyElement=[__request writeElement:item type:[KPUTicketInfo class] name:@"TicketInfo" URI:@"http://www.apoyar.net/" parent:__parent skipNullProperty:NO];
...
- (void)removeObjectIdenticalTo:(KPUTicketInfo*)anObject inRange:(NSRange)range {
	return [self.items removeObjectIdenticalTo:anObject inRange:range];
}

- (void)removeObjectIdenticalTo:(KPUTicketInfo*)anObject {
...
+ (id)array {
	return [[ KPUArrayOfTicketInfo alloc] init];
}

+ (id)arrayWithObject:(KPUTicketInfo*)anObject {
	return [[ KPUArrayOfTicketInfo alloc] initWithObjects:anObject, nil];
}

+ (id)arrayWithObjects:(const KPUTicketInfo* *)objects count:(NSUInteger)cnt {
	return [[ KPUArrayOfTicketInfo alloc] initWithObjects:objects count:cnt];
}

+ (id)arrayWithObjects:(KPUTicketInfo*)firstObj, ... {
	KPUArrayOfTicketInfo* a = [ KPUArrayOfTicketInfo array];
	id eachObject;
...
- (id)initWithObjects:(KPUTicketInfo*)firstObj, ... {
	if(self = [self init]) {
		id eachObject;
		va_list argumentList;
		if (firstObj) {
...
+ (id)arrayWithArray:(NSArray *)array {
	return [[ KPUArrayOfTicketInfo alloc] initWithArray:array];
}

+ (id)arrayWithContentsOfFile:(NSString *)path {
	return [[ KPUArrayOfTicketInfo alloc] initWithContentsOfFile:path];
}

+ (id)arrayWithContentsOfURL:(NSURL *)url {
	return [[ KPUArrayOfTicketInfo alloc] initWithContentsOfURL:url];
}

+ (id)arrayWithCapacity:(NSUInteger)numItems {
	return [[ KPUArrayOfTicketInfo alloc] initWithCapacity:numItems];
}
